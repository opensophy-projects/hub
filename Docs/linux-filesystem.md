---
title: "Учим Linux: Файловая система"
...
Давайте не будем вдаваться в элементарные подробности терминологии что такое файловая система итп, расскажу только что статья подготовлена для новичков и спецов желающие обновить свои знания, я постарался написать коротко и всю суть про файловую систему. Всего частей будет 11.
...
:::note
В Ubuntu/Debian `locate` устанавливается отдельно: `sudo apt install mlocate`. База обновляется автоматически через cron, обычно раз в сутки.
:::
