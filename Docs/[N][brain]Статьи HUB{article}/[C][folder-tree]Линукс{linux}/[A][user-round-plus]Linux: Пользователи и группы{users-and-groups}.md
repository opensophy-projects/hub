...
Продолжаем прохождение linux! Сразу уточню что статья может обновляться после адекватной критики и уточнений от сообщества [Хабра](https://habr.com/ru/users/hub/)(там где офицально статья была опубликована от hub), свежие обновления всегда происходят на hub.com, если вы только начинаете изучать линукс или хотите освежить память можете вернуться в прошлую серию рубрики "[Учим Linux: Файлы, навигация и поиск](https://hub.com/article/linux/linux-files/)". В этой части я попытался расписать довольно кратко т.к. информации и так много и тот же новичок может не сразу все выучить но по комментариям из Хабра я буду создавать что-то вроде чеклиста оперативных вопросов(это если я пропустил что-то из важной информации). Приступим. 
