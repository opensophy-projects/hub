...
Компонент фонового эффекта **Цветовые изгибы** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/color-bends/color-bends';
...
- `src/features/ui-components/color-bends/color-bends.tsx`
