---
title: "Лучи"
description: UI Компонент. Анимированный фоновый эффект лучи.
date: 2026-05-18
...
Декоративный фон **Лучи** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import Beams from '@/features/ui-components/beams/beams';
