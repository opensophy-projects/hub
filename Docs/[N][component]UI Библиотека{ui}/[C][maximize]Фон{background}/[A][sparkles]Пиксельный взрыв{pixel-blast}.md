...
Компонент фонового эффекта **Пиксельный взрыв** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/pixel-blast/pixel-blast';
...
- `src/features/ui-components/pixel-blast/pixel-blast.tsx`
