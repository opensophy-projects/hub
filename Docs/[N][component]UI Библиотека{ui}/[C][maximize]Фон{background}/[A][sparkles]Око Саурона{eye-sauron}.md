...
Компонент фонового эффекта **Око Саурона** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/eye-sauron/eye-sauron';
...
- `src/features/ui-components/eye-sauron/eye-sauron.tsx`
