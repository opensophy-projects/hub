...
Компонент фонового эффекта **Аурора** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/aurora/aurora';
...
- `src/features/ui-components/aurora/aurora.tsx`
