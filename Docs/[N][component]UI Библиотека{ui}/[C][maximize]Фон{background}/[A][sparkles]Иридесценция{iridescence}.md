...
Компонент фонового эффекта **Иридесценция** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/iridescence/iridescence';
...
- `src/features/ui-components/iridescence/iridescence.tsx`
