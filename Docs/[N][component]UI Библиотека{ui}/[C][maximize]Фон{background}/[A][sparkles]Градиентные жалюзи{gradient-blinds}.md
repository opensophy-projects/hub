...
Компонент фонового эффекта **Градиентные жалюзи** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/gradient-blinds/gradient-blinds';
...
- `src/features/ui-components/gradient-blinds/gradient-blinds.tsx`
