...
Декоративный фон **Иридесценция** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import Iridescence from '@/features/ui-components/iridescence/iridescence';
