---
title: "Световые лучи"
description: UI Компонент. Анимированный фоновый эффект световые лучи.
date: 2026-05-18
...
Декоративный фон **Световые лучи** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import LightRays from '@/features/ui-components/light-rays/light-rays';
