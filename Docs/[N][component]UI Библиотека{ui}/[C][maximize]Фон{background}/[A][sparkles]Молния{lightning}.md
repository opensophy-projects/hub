...
Компонент фонового эффекта **Молния** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/lightning/lightning';
...
- `src/features/ui-components/lightning/lightning.tsx`
