...
description: UI Компонент. Анимированный фоновый эффект цветовые изгибы.
date: 2026-05-18
...
Декоративный фон **Цветовые изгибы** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import ColorBends from '@/features/ui-components/color-bends/color-bends';
