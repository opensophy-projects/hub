...
Декоративный фон **Градиентные жалюзи** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import GradientBlinds from '@/features/ui-components/gradient-blinds/gradient-blinds';
