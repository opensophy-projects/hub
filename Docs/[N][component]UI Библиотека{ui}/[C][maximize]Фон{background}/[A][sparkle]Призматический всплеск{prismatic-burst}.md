...
description: UI Компонент. Анимированный фоновый эффект призматический всплеск.
date: 2026-05-18
...
Декоративный фон **Призматический всплеск** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import PrismaticBurst from '@/features/ui-components/prismatic-burst/prismatic-burst';
