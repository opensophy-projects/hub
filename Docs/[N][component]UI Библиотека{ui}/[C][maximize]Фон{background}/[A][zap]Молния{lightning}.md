---
title: "Молния"
description: UI Компонент. Анимированный фоновый эффект молния.
date: 2026-05-18
...
Декоративный фон **Молния** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import Lightning from '@/features/ui-components/lightning/lightning';
