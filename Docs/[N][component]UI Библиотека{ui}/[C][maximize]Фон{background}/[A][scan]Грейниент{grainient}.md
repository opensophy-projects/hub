---
title: "Грейниент"
description: UI Компонент. Анимированный фоновый эффект грейниент.
date: 2026-05-18
...
Декоративный фон **Грейниент** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import Grainient from '@/features/ui-components/grainient/grainient';
