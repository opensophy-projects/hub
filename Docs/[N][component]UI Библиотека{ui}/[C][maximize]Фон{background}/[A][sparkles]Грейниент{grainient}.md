...
Компонент фонового эффекта **Грейниент** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/grainient/grainient';
...
- `src/features/ui-components/grainient/grainient.tsx`
