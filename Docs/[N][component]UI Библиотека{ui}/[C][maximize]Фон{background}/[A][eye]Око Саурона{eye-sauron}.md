---
title: "Око Саурона"
description: UI Компонент. Анимированный фоновый эффект око саурона.
date: 2026-05-18
...
Декоративный фон **Око Саурона** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import EyeSauron from '@/features/ui-components/eye-sauron/eye-sauron';
