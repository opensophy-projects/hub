...
Декоративный фон **Плавающие линии** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import FloatingLines from '@/features/ui-components/floating-lines/floating-lines';
