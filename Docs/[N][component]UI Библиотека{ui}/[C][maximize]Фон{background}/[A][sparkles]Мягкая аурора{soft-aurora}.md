...
Компонент фонового эффекта **Мягкая аурора** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/soft-aurora/soft-aurora';
...
- `src/features/ui-components/soft-aurora/soft-aurora.tsx`
