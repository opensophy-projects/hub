---
title: "Поле точек"
description: UI Компонент. Анимированный фоновый эффект поле точек.
date: 2026-05-18
...
Декоративный фон **Поле точек** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import DotField from '@/features/ui-components/dot-field/dot-field';
