...
Компонент фонового эффекта **Призма** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/prism/prism';
...
- `src/features/ui-components/prism/prism.tsx`
