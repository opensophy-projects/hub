...
Компонент фонового эффекта **Лучи** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/beams/beams';
...
- `src/features/ui-components/beams/beams.tsx`
