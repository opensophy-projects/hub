...
Компонент фонового эффекта **Световые лучи** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/light-rays/light-rays';
...
- `src/features/ui-components/light-rays/light-rays.tsx`
