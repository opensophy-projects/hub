---
title: "Мягкая аурора"
description: UI Компонент. Анимированный фоновый эффект мягкая аурора.
date: 2026-05-18
...
Декоративный фон **Мягкая аурора** для hero-блоков, секций и лендингов. Оформлен в едином формате как страница «Темная вуаль»: с зависимостями, использованием, рекомендациями и полным исходным кодом.
...
```tsx
import SoftAurora from '@/features/ui-components/soft-aurora/soft-aurora';
