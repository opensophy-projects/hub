...
Компонент фонового эффекта **Поле точек** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/dot-field/dot-field';
...
- `src/features/ui-components/dot-field/dot-field.tsx`
