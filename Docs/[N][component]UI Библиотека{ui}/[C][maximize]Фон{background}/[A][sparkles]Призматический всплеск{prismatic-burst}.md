...
Компонент фонового эффекта **Призматический всплеск** для UI-сцен и декоративных секций страницы.
...
```tsx
import Component from '@/features/ui-components/prismatic-burst/prismatic-burst';
...
- `src/features/ui-components/prismatic-burst/prismatic-burst.tsx`
