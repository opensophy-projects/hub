---
title: "Размытый текст | UI Компонент"
description: Текст с эффектом случайного фаззинга строк через Canvas. Каждая строка пикселей независимо смещается по горизонтали, создавая органичный шум. Поддерживает hover, глитч-режим, градиент и плавные переходы.
author: davidhdev
date: 2026-05-06
