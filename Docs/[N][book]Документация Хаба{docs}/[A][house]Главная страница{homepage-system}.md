...
:::tip
В `welcome.md` можно использовать `[uic:blur-text]`, `[uic:gradient-text]`
и другие компоненты библиотеки — это делает главную страницу визуально богатой
без написания React-кода.
:::
