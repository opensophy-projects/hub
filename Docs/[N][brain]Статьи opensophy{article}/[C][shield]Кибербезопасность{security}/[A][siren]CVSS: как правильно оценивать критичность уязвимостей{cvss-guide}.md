---
title: "Кратко о CVSS: как правильно оценивать критичность уязвимостей"
...
Ссылка: [cve.org](https://www.cve.org/)
...
Ссылка: [nvd.nist.gov](https://nvd.nist.gov/)
...
Ссылка: [owasp.org](https://owasp.org/)
...
Ссылка: [portswigger.net/web-security](https://portswigger.net/web-security)
...
Ссылка: [exploit-db.com](https://www.exploit-db.com/)

Опционально еще **БДУ ФСТЭК** — российская база данных угроз безопасности информации. Для организаций, работающих под требованиями российского законодательства (КИИ, персональные данные) — но там почему-то нет https и весьма сомнительно показалось от этого, поэтому поискать думаю сами можете :_)
