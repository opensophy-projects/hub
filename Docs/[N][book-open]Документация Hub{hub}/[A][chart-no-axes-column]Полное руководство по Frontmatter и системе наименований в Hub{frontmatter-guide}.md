...
```
[N][brain]Статьи hub{article}
```

- Иконка `brain` отображается в переключателе
- Название `Статьи hub` — подпись раздела
...
```yaml
canonical: https://hub.com/article/original
# или если дублей нет:
canonical: null
```
...
description: Hub проекта HUB — центр знаний по ИИ и кибербезопасности.
author: ""
date: 2026-03-07
tags: welcome, hub, hub
keywords: HUB, Hub, документация
canonical: null
robots: index, follow
lang: ru
---
