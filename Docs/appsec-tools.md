...
# Введение в DAST, SAST, SCA, IAST / RASP и их бесплатные примеры
...
*   **Бесплатный план:** "Free Forever" план включает до 10 сканирований в месяц (ZAP, Nmap, OpenVAS).
...
*   **Мнение:** Отличный вариант для публичных репозиториев, выводи много информации о потенциальных проблемах + большая библиотека правил. Не самый лучший для приватных тк мало в бесплатном тарифе для приват репозиторие возможностей + присутвует локальная версия и часто видел в вакансиях именно этот продукт на позициях AppSec / DevSecOps.
...
*   **Лицензия:** LGPL v3.
*   **Установка:** Docker-образ `sonarqube:community`.
...
Для эффективного старта с нулевым бюджетом:
1.  **SCA:** Включите Dependabot на GitHub или добавьте шаг с Trivy в CI.
2.  **SAST:** Подключите SonarCloud (для публичных) или Semgrep (для приватных до 10 чел).
3.  **DAST:** Настройте еженедельное сканирование через HostedScan или запускайте ZAP в Docker.
4.  **IAST:** Если вы пишете на Java/.NET, обязательно попробуйте Contrast CE.
