...
const IconNetwork: React.FC<{ color: string }> = ({ color }) => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
...
const TrailsInFormsScene: React.FC = () => {
  ...
  useEffect(() => {
    ...
    scene.background = new THREE.Color(TRAILS_PARAMS.backgroundColor);
  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-2xl bg-[#141414]">
      ...
      />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,transparent_55%,rgba(10,10,10,0.4)_100%)]" />
    </div>
  );
};
    ...
    <section style={{
      ...
      <div className="eco-inner">
        ...
        <div className="eco-cards">
          ...
          <EcoCard
            isNegative={isNegative}
            icon={<IconNetwork color={iconClr} />}
            iconBg={iconBg}
