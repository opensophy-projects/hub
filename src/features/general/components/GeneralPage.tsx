      ...
      <div className="eco-inner">
        ...
        <div className="eco-cards">
          ...
          <FeatureCard
            ...
            badge="веб-проект"
            text="Библиотека готовых React-компонентов с анимациями, интерактивными элементами и фирменным UI от Opensophy. Удобные, современные и гибко настраиваемые компоненты для разработчиков и дизайнеров. Каждый компонент проходит проверку качества, производительности и безопасности кода."
          />
        </div>
